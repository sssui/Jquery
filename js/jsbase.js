;(function () {
    ...
    function listen_task_detail(){
    	// var $task_detail_trigger = $('action.detail');
        var index;
    ...
    function listen_checkbox_complete(){
        $('.task-list .complete[type=checkbox]').on('click',function(){
           var $this = $(this);
    ...
    function show_task_detail(index){
       ...
       current_index = index;
       // 显示详情模板
       $('.task-detail').show(index);
       // 显示详情模板mask
       $('.task-detail-mask').show(index);
    }
    ...
    function render_task_detail(index){
        ...
        var tpl = 
           '<form>'+	
                ...
                '<lable>提醒时间</lable>'+
				'<input class="datetime" name ="remind_date" autocomplete="off" type="text" value="'+(item.remind_date||'')+'" type="date">'+
				'</div>'+
   ...
   /*    function listen_task_delete(){
    ...
    // 查找并监听所有删除按钮的点击时间
    function listen_task_delete(){
    	var $task_delete_trigger = $('.action.delete');
 ...
 /*	$('.task-list').on('click','.delete',function(){
    ...
    function render_task_list(){
    	...
    	// $delete_task = $('.action.delete');
         ...
         // $checkbox_complete=$('.task_list.complete');
    	listen_task_delete();
    	listen_task_detail();
